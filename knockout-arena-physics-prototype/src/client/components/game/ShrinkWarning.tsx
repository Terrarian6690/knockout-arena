...
export function ShrinkWarning({
  ...
  return (
    <div
      ...
      // The match clock used to float in this same band, so this used to
      // be padded down (pt-14) to clear it. The clock now lives in the
      // top bar, so the warning has the band to itself and sits at the
      // top of the arena where it is noticed soonest.
